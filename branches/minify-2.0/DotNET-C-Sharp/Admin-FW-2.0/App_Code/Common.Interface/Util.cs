...
namespace Common
{
	...
	public static partial class Util
	{
		...
		/**
		 * Common.Util.GlobalPath Returns the global path for external theme files (xml, css, jpg, gif, swf)
		 * @return String the global path for external files (xml, css, jgs, gif, swf)
		 * @usage
				<code>
					<%=Common.Util.GlobalPath;%> // writes "http://ROOT/locales/global/themes/theme1/"
				</code>
		 */
		public static string GlobalThemePath
		{
			get
			{
				return Root + "locales/global/themes/"+Theme+"/";
			}
		}

		/**
		 * Common.Util.LanguagePath 
		 * @return String the especific path for external theme files (xml, css, jpg, gif, swf)
		 * @usage
				<code>
					<%=Common.Util.LanguagePath;%> // writes "http://ROOT/locales/pt-BR/themes/theme1/"
				</code>
		 */
		public static string LanguageThemePath
		{
			get
			{
				return Root + "locales/pt-BR/themes/"+Theme+"/";
			}
		}
		 ...
		 * @return String the especific language
		 * @usage
				<code>
		...
		/**
		 * Common.Util.Theme 
		 * @return String the especific theme
		 * @usage
				<code>
					<%=Common.Util.Theme;%> // writes "fbiz"
				</code>
		 */
