...
<asp:content contentplaceholderid="cphMainContent" runat="server">
	...
	<div class="primary_content">
		<h2>Bem-vindo ao Admin <%=Common.Config.ProjectName%></h2>
		<p>
		...
		<div class="attention">Atenção! - Esta é uma mensagem de atenção.</div>
		<div class="information">Esta é uma mensagem informativa.</div>
		...
		<div class="tabs">
			...
			<div class="tabContent" id="tab-1">
				...
				<table class="tablesorter zebra"> <!-- use "zebra" class to alternate TRs background -->
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							...
							<td>
								<a href="#" title="User"><img src="<%=Common.Util.GlobalThemePath%>img/user.png" alt="User" width="16" height="16" /></a>
								<a href="#" title="Accept"><img src="<%=Common.Util.GlobalThemePath%>img/accept.png" alt="Accept" width="16" height="16" /></a>
								<a href="#" title="Close"><img src="<%=Common.Util.GlobalThemePath%>img/delete.png" alt="Close" width="16" height="16" /></a>
							</td>
						</tr>
						<tr>
							<td>
			...
			<div class="tabContent" id="tab-2">
				...
				<p>
					<input name="check1" class="checkbox" id="check1" type="checkbox" />
					<label class="checkbox" for="check1">checkbox comum</label>
				</p>
				<p>
					<input name="check2" class="checkbox" id="check2" checked="checked" type="checkbox" />
					<label class="checkbox" for="check2">checkbox comum</label>
				</p>
				<p>
					<label>
						Radio Buttons
					</label>
					<input name="radio" class="radio" id="radio1" value="radio1" type="radio" />
					<label class="checkbox" for="radio1">radio comum</label> 
				</p>
				<p>
					<input name="radio" class="radio" id="radio2" value="radio1" type="radio" />
					<label class="checkbox" for="radio2">radio comum</label>
				</p>
				<p>
					<input name="radio" class="radio" id="radio3" value="radio3" type="radio" />
					<label class="checkbox" for="radio3">radio comum</label> 
				</p>
				<p>
					<label for="combo">
						Drop Down (Combo) List
					</label>
					<select name="combo" id="combo" class="select input">
				...
				<p>
					...
					<textarea name="textarea" id="textarea" cols="50" rows="7" class="styled_textarea">Text area for lots of lines of text...</textarea>
				</p>
				<p>
