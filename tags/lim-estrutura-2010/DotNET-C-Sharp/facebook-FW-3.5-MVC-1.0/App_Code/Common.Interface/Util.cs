...
namespace Common
{
	...
	public static partial class Util
	{
		...
		public static string Write(string uri){
		...
		public static string WriteMinified(string uri){			
			return Common.Util.Write( Common.Util.Root + "minify.aspx?" + uri + "&amp;bpc=" + Common.Util.Bpc + "&amp;v=" + Common.Util.Version );			
		}
